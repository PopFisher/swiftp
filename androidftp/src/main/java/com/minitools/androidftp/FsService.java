...
import com.minitools.androidftp.server.SessionThread;
import com.minitools.androidftp.server.TcpListener;
import com.minitools.androidftp.ui.FsNotification;
...
public class FsService extends Service implements Runnable {
    ...
    public static void start() {
        Context context = FtpAndroid.getAppContext();
    ...
    private static void warnIfNoExternalStorage() {
        ...
        if (!storageState.equals(Environment.MEDIA_MOUNTED)) {
            ...
            Toast toast = Toast.makeText(FtpAndroid.getAppContext(),
