...
package com.minitools.androidftp.server;
...
import com.minitools.androidftp.MediaUpdater;
import com.minitools.androidftp.util.FileUtil;
    ...
    public void doStorOrAppe(String param, boolean append) {
        ...
        storing:
        {
            ...
            try {
                if (storeFile.exists()) {
                    if (!append) {
                        if (!FileUtil.deleteFile(storeFile, FtpAndroid.getAppContext())) {
                ...
                if (!storeFile.exists()) {
                    FileUtil.mkfile(storeFile, FtpAndroid.getAppContext());
                }
                out = FileUtil.getOutputStream(storeFile, FtpAndroid.getAppContext());
